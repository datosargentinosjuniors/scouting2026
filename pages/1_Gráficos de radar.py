...
CONFIG = {
    "Defensores centrales": {
        "excel": "data/todos_defensoresCentrales_todos_20252026.xlsx",
        "radar": [
            "Gol y Finalización",
    ...
    "Laterales": {
        "excel": "data/final_laterales_todos_20252026.xlsx",
        "radar": [
            "Gol y Finalización",
            "Asistencias y creación de chances",
            "1v1 en ataque",
        ...
        "subpuesto": {
            ...
            "mode": "contains_RL",  # filtra df['Position'] por R/L
    ...
    "Volantes defensivos": {
        "excel": "data/final_volantesDefensivos_todos20252026.xlsx",
        "radar": [
            "Gol y Finalización",
            "Asistencias y creación de chances",
            "1v1 en ataque",
    ...
    "Volantes mixtos": {
        "excel": "data/final_volantesMixtos_todos_20252026.xlsx",
        "radar": [
            "Gol y Finalización",
            "Asistencias y creación de chances",
            "1v1 en ataque",
    ...
    "Volantes ofensivos": {
        "excel": "data/final_volantesOfensivos_todos_20252026.xlsx",
        "radar": [
            "Gol y Finalización",
            "Asistencias y creación de chances",
            "1v1 en ataque",
    ...
    "Extremos": {
        "excel": "data/final_extremos_todos_20252026.xlsx",
        "radar": [
            "Gol y Finalización",
            "Asistencias y creación de chances",
            "1v1 en ataque",
    ...
    "Delanteros centrales": {
        "excel": "data/final_delanterosCentrales_todos_20252026.xlsx",
        "radar": [
            "Gol y Finalización",
            "Asistencias y creación de chances",
            "1v1 en ataque",
...
# Validaciones base
base_required = ["Minutes played", "Foot", "FiltroPais", "Jugador con equipo", "Puntaje AAAJ"]
...
with col2:
    ...
    radar = Radar(
        params=radar_cols,
        min_range=[float(df[c].min()) for c in radar_cols],
        max_range=[float(df[c].max()) for c in radar_cols],
    )
    ...
    values_1 = list(data_j1[radar_cols].iloc[0].astype(float).values)
    ...
    if data_j2 is not None and not data_j2.empty:
        values_2 = list(data_j2[radar_cols].iloc[0].astype(float).values)
...
columnas_tabla = ["Jugador con equipo", "Puntaje AAAJ"] + radar_cols
...
columnas_finales = ["Ranking", "Jugador con equipo", "Puntaje AAAJ"] + radar_cols
